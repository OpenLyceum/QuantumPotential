    ...
    plugins: single
      ...
      : [
          VitePWA({
            ...
            manifest: {
              id: "quantum-potential",
              name: "Quantum Physics: Potential Wells",
              // biome-ignore lint/style/useNamingConvention: Web App Manifest spec requires snake_case keys
              short_name: "QuantumPotential",
              description:
                "Explore bound states of a quantum particle in potential wells with real-time solutions of the 1D Schrödinger equation.",
              ...
              screenshots: [
                {
                  ...
                  // biome-ignore lint/style/useNamingConvention: Web App Manifest spec requires snake_case keys
                  form_factor: "wide",
                  label: "Quantum Physics: Potential Wells",
                },
                {
